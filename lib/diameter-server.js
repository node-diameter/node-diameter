...
function DiameterServer(options) {
    ...
    if (self.options.originHost == null) {
        throw new Error('Options must include originHost');
    }
    if (self.options.originRealm == null) {
        throw new Error('Options must include originRealm');
    }
